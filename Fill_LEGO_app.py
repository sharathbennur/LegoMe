...
def amLookupASIN2(myPanda,ASIN):
    ...
    try:
        ...
        myPanda.loc[newRow,'index']=newRow
        lookUP = amazon_api.item_lookup(ASIN) # then lookUP and update myPanda
        for item in lookUP.Items.Item:
...
# actually run this baby
wait_time = 5
fn = '/Users/sharathbennur/Insights/Project/legoSet.pkl'
fn5 = '/Users/sharathbennur/Insights/Project/legoSet5.pkl'
...
for nASIN in ASINs:
    print nASIN
    try:
        getLegoSet(nASIN, legos)
        wait_time = 5
    except:
        wait_time = wait_time+2
    # try not to annoy the websites
